...
using both recursive and iterative method. Input has been handled for you through "help.h".
...
CORRECT CODE FOR CO-ORDINATORS:
*/
#include <stdio.h>
#include <stdlib.h>
#include <lastlog.h>
...
#include <stdbool.h>
#include "help.h"
//HEADER FILES JUST TO CREATE A CONFUSION...NO SIGNIFICANCE
int binary_rec(int);
int binary(int);
...
int binary(int num)
{
    ...
    while (num)
    {
        ...
        num = num / 2;
        bin = bin + rem * place;
        place *= 10;        //THIS LINE IS MISSING IN BUGGY CODE
    }
    return (bin);
}